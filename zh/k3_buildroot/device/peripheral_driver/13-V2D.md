...
| 功能  | 性能规格 |
| :-----| :----|
| 颜色填充 | 4096x2304@60 FPS |
| 格式转换 | 4096x2304@60 FPS |
...
V2D 使用两个主时钟源：`v2d-io` 和 `v2d-core`。可通过写入 `/sys/bus/platform/devices/c0100000.v2d/clkrate` 实现动态调整。

配置平台 V2D 相关 clock 和 reset 示例如下。

```c
// linux-6.18/scripts/dtc/include-prefixes/riscv/spacemit/k3.dtsi
v2d: v2d@c0100000 {
