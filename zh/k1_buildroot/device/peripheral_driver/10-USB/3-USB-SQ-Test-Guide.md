...
完整的 USB 2.0 电气信号质量测试内容可以在 USB-IF 官网中找到：- [USB 2.0 Electrical Compliance Specification | USB-IF Document Library](https://www.usb.org/document-library/usb-20-electrical-compliance-test-specification-version-107)
...
注：需要较新版本的 SpacemiT 内核才提供本节对 USB2.0 OTG 控制器 DebugFS 的支持。K1 开发板的 USB2.0 OTG 控制器在 Device 模式下，可通过 Linux DebugFS 节点直接操作控制器进行测试波形配置，具体操作如下：
